...
function GermanFlag() {
    return (
        <svg style={svgSize} viewBox="-3.6 -3.6 43.20 43.20" xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true" role="img" className="iconify iconify--twemoji"
            preserveAspectRatio="xMidYMid meet" fill="#000000">
            <g id="SVGRepo_bgCarrier" strokeWidth="0">
                <rect x="-3.6" y="-3.6" width="43.20" height="43.20" rx="21.6" fill="#ffffff" strokeWidth="0"></rect>
            </g>
