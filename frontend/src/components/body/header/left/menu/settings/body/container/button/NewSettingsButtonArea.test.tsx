...
describe("NewSettingsButtonArea", () => {
	test("should render", () => {
		render(<NewSettingsButtonArea handleProfileSettingsUpdateSaveButtonClick={() => {}} onClose={() => {}} />);
	...
	test("click on cancel should trigger onClose", () => {
		const onClose = vi.fn();
		render(<NewSettingsButtonArea handleProfileSettingsUpdateSaveButtonClick={() => {}} onClose={onClose} />);
	...
	test("click on save should trigger onClose", () => {
		const onSave = vi.fn();
		render(<NewSettingsButtonArea handleProfileSettingsUpdateSaveButtonClick={onSave} onClose={() => {}} />);
