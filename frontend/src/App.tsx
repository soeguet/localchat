...
import clientUserName from "./utils/envVariables";
...
function App() {
    ...
    useEffect(() => {
        ...
        /**
         * Retrieves the username from the client and sets it in the state. Such a pain..
         */
        ...
        socket.addEventListener("message", async (event) => {
            ...
            await addMessageIfUniqueId(messagesMap, setMessagesMap, dataAsObject);
        });
    }, []);
